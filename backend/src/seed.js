...
// Atenção: apaga o que já estiver cadastrado antes de inserir.
...
// Usado quando o projeto sobe na nuvem: se o banco estiver vazio, popula sozinho
function popularSeVazio() {
  const resultado = db.prepare('SELECT COUNT(*) AS total FROM fornecedores').get();
...
module.exports = { popularBanco, popularSeVazio };

// Executa quando o arquivo é chamado direto pelo terminal (npm run seed)
